...
/**
 * ViewModel holding state after dealing cards.
 */
public class PlaceBetAndDealViewModel {
    ...
    public void setDealerVisibleTotal(int dealerVisibleTotal) { this.dealerVisibleTotal = dealerVisibleTotal; }
    public double getBalance() { return balance; }
    public void setBalance(double balance) { this.balance = balance; }
    public double getBetAmount() { return betAmount; }
    public void setBetAmount(double betAmount) { this.betAmount = betAmount; }
    public boolean isInitialBlackjack() { return initialBlackjack; }
    public void setInitialBlackjack(boolean initialBlackjack) { this.initialBlackjack = initialBlackjack; }
}